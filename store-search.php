            ...
            <div class="col-sm-9 row">
              ...
              // pagination + display 
                ...
                if(isset($_GET['searchText']) && !empty($_GET['searchText'])) {
                  ...
                  $sql = "SELECT id FROM products WHERE id_categories LIKE '%$searchText%' OR name LIKE '%$searchText%' OR author LIKE '%$searchText%' OR performance LIKE '%$searchText%' OR music_type LIKE '%$searchText%' OR release_year LIKE '%$searchText%' AND isDeleted=0";
                  $result = dbSelect($sql);
                  $totalRecord = count($result);
                  $totalPage = ceil($totalRecord / $recordPerPage);

                  
                  $sql = "SELECT * FROM products WHERE id_categories LIKE '%$searchText%' OR name LIKE '%$searchText%' OR author LIKE '%$searchText%' OR performance LIKE '%$searchText%' OR music_type LIKE '%$searchText%' OR release_year LIKE '%$searchText%' AND isDeleted=0 LIMIT $offset, $recordPerPage;;";
                  $result = dbSelect($sql);
