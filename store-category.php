<?php 
  ...
  if(isset($_GET['idCate']) && !empty($_GET['idCate'])) {
    $idCate = $_GET['idCate'];
  }
        ...
        <div class="row">
            ...
            <div class="col-sm-9 row">
              ...
              // pagination + display table
                ...
                $sql = "SELECT id FROM products WHERE id_categories='$idCate' AND isDeleted=0";
                $result = dbSelect($sql);
                $totalRecord = count($result);
                $totalPage = ceil($totalRecord / $recordPerPage);
                $sql = "SELECT * FROM products WHERE id_categories='$idCate' AND isDeleted=0 LIMIT $offset, $recordPerPage;";
                $result = dbSelect($sql);
